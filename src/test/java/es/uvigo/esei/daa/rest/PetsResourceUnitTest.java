...
public class PetsResourceUnitTest{
	...
	public void testModify() throws Exception {
		...
		final Response response = resource.modify(
				pet.getId(), pet.getName(), pet.getSpecies(), pet.getBreed(), pet.getOwner());
	...
	public void testModifyDAOException() throws Exception {
		...
		final Response response = resource.modify(existentId(), newName(), newSpecies(), newBreed(), newOwner());
	...
	public void testAdd() throws Exception {
		expect(daoMock.add(newName(), newSpecies(), newBreed(), newOwner()))
			.andReturn(newPet());
		replay(daoMock);
		

		final Response response = resource.add(newName(), newSpecies(), newBreed(), newOwner());
	...
	public void testAddDAOException() throws Exception {
		expect(daoMock.add(anyString(), anyString(), anyString(), anyInt()))
